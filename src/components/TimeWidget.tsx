...
const TimeWidget = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-0 my-1 md:my-2">
      <h2 className="text-lg md:text-xl font-mono text-cyan-400/80 uppercase tracking-widest tech-text">BENTORNATO, {settings.userName.toUpperCase()}</h2>
      <h1 className="text-6xl md:text-8xl font-bold text-cyan-50 tracking-tighter drop-shadow-[0_0_15px_rgba(6,182,212,0.5)] leading-none my-1">{formatTime(time)}</h1>
